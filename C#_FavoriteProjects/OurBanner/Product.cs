...
namespace OurBanner
{
    public class Product
    {
        ...
        public Product(int anId, string aproductName, int asupplierId, int acategoryId, string aquantityPerUnit, double aunitPrice, int aunitsInStock, 
            int aunitsOnOrder, int areorderLevel, bool adiscontinued)
            : this()
        {
        ...
        public Product(int anId, string aproductName, int asupplierId, int acategoryId, string aquantityPerUnit, double aunitPrice, 
            int aunitsInStock, int aunitsOnOrder, int areorderLevel)
            : this(anId, aproductName, asupplierId, acategoryId, aquantityPerUnit, aunitPrice, aunitsInStock, aunitsOnOrder, areorderLevel, 
            false)
        {
        ...
        public Product(int anId, string aproductName, int asupplierId, int acategoryId, string aquantityPerUnit, double aunitPrice, 
            ...
            : this(anId, aproductName, asupplierId, acategoryId, aquantityPerUnit, aunitPrice, aunitsInStock, aunitsOnOrder, -1,
            false)
        {
        ...
        public Product(int anId, string aproductName, int asupplierId, int acategoryId, string aquantityPerUnit, double aunitPrice, 
            int aunitsInStock)
            : this(anId, aproductName, asupplierId, acategoryId, aquantityPerUnit, aunitPrice, aunitsInStock, -1, -1, false)
        {
        ...
        public Product(int anId, string aproductName, int asupplierId, int acategoryId, string aquantityPerUnit)
            : this(anId, aproductName, asupplierId, acategoryId, aquantityPerUnit, 0, -1, -1, -1, false)
        {

        }

        public Product(int anId, string aproductName, int asupplierId, int acategoryId)
            : this(anId, aproductName, asupplierId, acategoryId, "n/a", 0, -1, -1, -1, false)
        {

        }

        public Product(int anId, string aproductName, int asupplierId)
            : this(anId, aproductName, asupplierId, -1, "n/a", 0, -1, -1, -1, false)
        {

        }

        public Product(int anId, string aproductName)
            : this(anId, aproductName, -1, -1, "n/a", 0, -1, -1, -1, false)
        {

        }

        public Product(int anId)
            : this(anId, "n/a", -1, -1, "n/a", -1, -1, -1, -1, false)
        {
