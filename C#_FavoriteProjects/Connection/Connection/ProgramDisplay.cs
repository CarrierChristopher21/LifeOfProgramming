...
namespace Connection
{
    public class ProgramDisplay
    {
        ...
        //  Console View
        ConsoleView aConsoleView = new ConsoleView();
        //  Student                         -       Student           -    1
        ...
        public string ProgramDisplay(int anSwitchId, string answer, int anId, string orderBy, int order, string answerMin, string answerMax, double aMin, double aMax)
        {
