...
namespace Connection
{
    ...
    {
        /*  Information about DBUtilityAdapterLoader
            This class collects the data from the database and then returns it to the controller. It pulls the data through data Adapters,
            which also use sql to create the table's as well. The student class pulls the data from xml file and the rest of the 8 class's
            pull their data from the database and creating and filling a table with the data adpater. This also uses DataSet's as well.
        */
        ...
        string OrderDetailsSQL = "SELECT [Order Details].OrderID, Products.ProductName, Customers.ContactName, Customers.ContactTitle, " +
            "Employees.TitleOfCourtesy, (Employees.FirstName + ' ' + Employees.LastName) AS [Employees Name], Employees.Title, [Order Details].UnitPrice, " +
        ...
        //  Orders SQL Call
        string OrdersSQL = "SELECT Orders.OrderID, Customers.ContactTitle, Customers.ContactName, Employees.TitleOfCourtesy, " +
                "(Employees.FirstName + ' ' + Employees.LastName) AS [Employees Name], Employees.Title, Orders.OrderDate, " + 
                "Orders.RequiredDate, Orders.ShippedDate, Orders.ShipVia, Orders.Freight, Orders.ShipName, Orders.ShipAddress, " + 
        ...
        //  Shippers SQL Call
        string ShippersSQL = "SELECT ShipperID, CompanyName, Phone " + 
        "FROM Shippers ";
        ...
        public DataTable GetCategoryOrder(string answer)
        {
            ...
            //  Fills the table with the data collected
        ...
        {                       
            ...
            aConnection.Open();
            //  Set the SQL Statement
            aCommand.CommandText = EmployeesSQL + "ORDER BY EmployeeID DESC;";
            //  Table Exist Test
            if(aDataSet.Tables.Contains("EmployeeTable"))
            {
                aDataSet.Tables["EmployeeTable"].Clear();
        ...
        public DataTable GetSupplierOrder(string answer)
        {
            ...
            aConnection.Open();
            //  Set the SQL Statement
            aCommand.CommandText = SuppliersSQL + "WHERE Suppliers.SupplierID = " + answer + ";";
            //  Table Exist Test
