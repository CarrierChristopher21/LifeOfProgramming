 ...
 *	Date:	1/15/15
 *	Information: This class is to establish a connection to the Northwind database and to be used for the Supplier Table, as
 *	well as the Supplier portion of this database program. It uses the OleDbConnection setup to establish the connection.
 */
