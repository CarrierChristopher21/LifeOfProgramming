...
namespace Northwind4.Models
{
    public class Product
    {
        ...
        {
            string aString = "";
			aString += "Product ID = " + ProductId + "<br />";
			aString += "Product Name = " + ProductName + "<br />";
			aString += "Company name = " + SupplierId + "<br />";
			aString += "Category Name = " + CategoryId + "<br />";
			aString += "Quantity Per Unit = " + QuantityPerUnit + "<br />";
			aString += "Unit Price = " + UnitPrice + "<br />";
			aString += "Units In Stock = " + UnitsInStock + "<br />";
			aString += "Units On Order = " + UnitsOnOrder + "<br />";
			aString += "ReOrderLevel = " + ReorderLevel + "<br />";
			aString += "Discontinued = " + Discontinued + "<br />";
