...
namespace Northwind2.Controllers
{
    public class HomeController : Controller
    {
        ...
        public PartialViewResult ListByProductAjax()
        {
            ...
            return PartialView("ListByProductAjax");
        }
        public PartialViewResult ListByProductAjaxExpensiveProducts()
        {
            ...
            var ExpensiveProductList = from p in aProductList where p.UnitPrice > 50 
                                       select p;



            ViewBag.ProductList = ExpensiveProductList.ToList<Product>();



            return PartialView("ListByProductAjaxExpensiveProducts");
        }
        public PartialViewResult ListByProductAjaxCheapProducts()
        {
            ...
            var CheapProductList = from p in aProductList
                                       where p.UnitPrice <10
                                       select p;



            ViewBag.ProductList = CheapProductList.ToList<Product>();
