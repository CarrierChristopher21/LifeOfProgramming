...
{
	//alert("hi");	
		result1.innerHTML = "ProductID Table Ascending: <br><br>" + aProducts.toTable() + "<br>";
...
function ResultsNameAsc()
{
	...
	result1.innerHTML = "Products Name Table Ascending: <br><br>" + aProducts.toTable() + "<br>";
}
...
function ResultsNameDesc()
{
	...
	result1.innerHTML = "Product Name Table Descending: <br><br>" + aProducts.toTable() + "<br>";
}

//	Product's UnitPrice Ascending
function ResultsPriceAsc()
{
	sortedArray = myArray.sort(comparePriceAsc);
	result1.innerHTML = "Product Price Table Ascending: <br><br>" + aProducts.toTable() + "<br>";
}

//	Product's UnitPrice Descending
function ResultsPriceDesc()
{
	sortedArray = myArray.sort(comparePriceDesc);
	result1.innerHTML = "Product Price Table Descending: <br><br>" + aProducts.toTable() + "<br>";
}
