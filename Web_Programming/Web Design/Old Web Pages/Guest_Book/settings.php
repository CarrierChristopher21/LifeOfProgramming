...
$settings['apass']='Christmas#18';

/* Website title */
$settings['website_title']="Your Web site";

/* Website URL */
$settings['website_url']='http://www.chris-gaming-info.com/Guest_Book/';

/* Guestbook title */
$settings['gbook_title']="My Web site Guestbook";

/* Your e-mail address. */
$settings['admin_email']='midnightscar17@yahoo.com';

/* URL of the gbook.php file. */
$settings['gbook_url']='http://www.chris-gaming-info.com/Guest_Book/gbook.php';
