<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" 
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
			<title>MySql Bug Report Update</title>
			<meta http-equiv="content-type" content="text/html; charset=iso-8859-1" />
		</head>
		<body>
			<h2>Update a MySql Bug Report</h2>
			...
			<p>Add another update to <a href="MySqlBugReport.php?BugFile=<?php echo $_POST['BugFile']; ?>">this bug</a>.</p>
			<p> or</p>
			...
			?>
				...
				<p>Return to the <a href="MySqlBugList.php">bug list</a>.</p>
