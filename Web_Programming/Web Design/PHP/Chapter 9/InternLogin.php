...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" 
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<p>New interns, please complete the top form to register as a user. Returning user, please complete 
				the second form to log in.</p>
			<hr />
			<h3>New Intern Registration</h3>
			<form method="post" action="RegisterIntern.php?<?php echo SID; ?>">
				<p>Enter your Name: 
			...
			<form method="post" action="VerifyLogin.php?<?php echo SID; ?>">
				<p>Enter your e-mail address:
					<input type="text" name="email" />
				</p>
				<p>Enter your password:
