function cart(A)
{
	...
	this.deleteItem=function(C)
	{
		...
		this.items=B;this.updateCookie();
		this.updatePageElements();
		return false
	};
						...
						else
						{
							...
							else
							{
								if(this.ItemColumns[C]=="Quantity")
								{
									...
									tempItem.functionString()+",'new_quantity=' + this.value);return false;\"value=\""+
	...
	this.updateQuantity=function()
	{
		...
		if(B<1)
		{
			this.deleteItem(newItem);return
		}
	...
	this.checkOut=function()
	{
		...
		for(C=0;C<this.items.length;C++)
		{
			...
			E=C+1;
			B=B+"&item_name_"+E+"="+tempItem.getValue("name")+"&item_number_"+E+"="+E+"&quantity_"+E+"="+tempItem.getValue("quantity")+
				"&amount_"+E+"="+this.returnFormattedPrice(tempItem.getValue("price"))+"&no_shipping_"+E+"=0&no_note_"+E+"=1";
