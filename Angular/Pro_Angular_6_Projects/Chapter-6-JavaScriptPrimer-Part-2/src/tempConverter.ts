...
/**	Using Access Modifiers in the tempConverter.ts File
...
/**	Specifying Any Type in the tempConverter.ts File **/
export class TempConverter {
	static convertFtoC(temp: any): string {
		let value: number;
		if((temp as number).toPrecision) {
...
/**	Using the as Keyword in the tempConverter.ts File
export class TempConverter {
...
/**	Accepting Multiple Values in the tempConverter.ts File Ex.6-18
export class TempConverter {
	static convertFtoC(temp : number | string) : string {
